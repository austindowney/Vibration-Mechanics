...
\subsection{Harmonic Excitations of Undamped Systems}
	...
	\noindent For the 1-DOF system:
		...
		\end{figure}
		\noindent with $k$ = 10~N/m, $m$ = 2.5~kg, $\omega$ = 4~rad/sec, $F_0$ = 0.1~kN, $x_0$ = 1~mm, and $v_0$ = 0~mm/s plot the temporal responses of the system considering the free-vibration case and the excited case. Plot these on a single plot to compare the responses. 
...
\begin{vibration_case_study}
	...
	Structural Health Monitoring during Earthquakes
