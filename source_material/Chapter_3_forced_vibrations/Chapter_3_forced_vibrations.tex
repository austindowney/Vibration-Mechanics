 ...
 \pagebreak
  ...
  \begin{example}
   ...
   \begin{figure}[H]
    ...
    \caption{A 1-DOF laterally excited system that represents a 1-story building. }
   \end{figure}    
   \pagebreak   
   \noindent\textbf{Solution (a):}
    
   \noindent  For simplicity, we can rearrange the system as follows:
   \begin{figure}[H]
    \centering
   ...
   \end{figure}
   \noindent solving for the EOM yields:
   \begin{equation}
    m\ddot{x} + kx = ky
   \end{equation}     
   ...
   \noindent From the plots we solved for before, we can see that we want a critical damping coefficient that is as low as possible. This means any damping added to the system will decrease its safety. This may seem counterintuitive, but this is because we are attempting to drive the structure at a frequency higher than its natural frequency, something that does not commonly happen. Typically, excitations for a structure are well below its natural frequency.     
