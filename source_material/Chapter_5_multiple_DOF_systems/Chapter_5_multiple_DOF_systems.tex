...
%	
	...
	\begin{example}
	\textbf{Mode shapes for a 5-DOF system.} \\

	\noindent N310GMU \rd{I need to update the math and code here, only the figure is updated. Make this a near pure matlab example}

\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{../figures/N310GMU}
	\caption{Displacement response of the 2-DOF system. \protect\footnotemark[1] \rd{I think I want to add two mass points between the engines and tanks, that wold make it look more like a wing.}}
	\label{fig:N310GMU}
\end{figure}
