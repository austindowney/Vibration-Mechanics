...
\begin{vibration_case_studies}
	Discuss vibration mitigation in tall structures
	\begin{figure}[H]
		\centering
...
\todo{add a short discussion on metrics, settling time, time to peak, and overshoot.}


The settling time ($t_s$) is the time its takes $x$ to get within $\epsilon \%$ of $x_{ss}$.
\begin{figure}[H]
	\centering
	\includegraphics[]{../figures/settling_time_overdamped}
\end{figure}

\todo{update, this math is form a 1-st order system.}
...
\begin{review}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=6in]{../figures/PID_Nicolas_Minorsky_and_USS_New_Mexico.png}
